...
disp(['--------------------------------------------------------- ']);
    ...
    for Num_Achohor=anchor_min:anchor_gap:anchor_max
        Node_Error_NUM_Percent =  Num_Achohor;
		             disp(['Node_Error_Num_Percent = ',num2str(Node_Error_NUM_Percent)]);
	disp(['************* ']); 
...
xlabel('\fontsize{12}\bf Percent of Node Fault');
ylabel('\fontsize{12}\bf Localization Error(in units)');
title('\fontsize{12}\bf  Localization Error vs. Node Fault Percent');
